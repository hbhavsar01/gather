 ...
 * @author Team Gather
 *
 *         This class validates UpdateEventData and ensures that the target
 *         event exists, and validates the new name, coordinates, description,
 *         category, participants and owners.
 *
 */
@Component
