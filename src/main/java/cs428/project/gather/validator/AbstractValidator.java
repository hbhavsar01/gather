 ...
 * @author Team Gather
 *
 *         Super class to all our validators. Provides email and URL pattern
 *         matching.
 */
public abstract class AbstractValidator implements Validator {
	// This ridiculously long regular expression conforms to the official RFC
	// 2822 standard.
	// See http://tools.ietf.org/html/rfc2822#section-3.4.1 and
	// http://www.regular-expressions.info/email.html for more information.
	private static final String INTERNET_MESSAGE_ADDRESS_REGULAR_EXPRESSION = "(?:[a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:\\.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)*|\"(?:[\\x01-\\x08\\x0b\\x0c\\x0e-\\x1f\\x21\\x23-"
	...
	private static final Pattern INTERNET_MESSAGE_ADDRESS_PATTERN = Pattern
			.compile(INTERNET_MESSAGE_ADDRESS_REGULAR_EXPRESSION, (Pattern.CASE_INSENSITIVE + Pattern.DOTALL));
	...
	private static final Pattern URL_PATTERN = Pattern.compile(URL_REGULAR_EXPRESSION,
