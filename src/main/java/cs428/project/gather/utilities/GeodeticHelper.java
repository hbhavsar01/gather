...
public final class GeodeticHelper {
	...
	public static double getDistanceBetweenCoordinates(Coordinates originCoordinates,
		...
		GeodeticMeasurement geodeticMeasurement = geodeticCalculator.calculateGeodeticMeasurement(Ellipsoid.WGS84,
				originGlobalPosition, destinationGlobalPosition);
