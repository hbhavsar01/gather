...
/**
 * 
 * @author Team Gather This class is the Events controller in charge of event
 *         related rest call such as add, remove, and update event
 * 
 */
...
public class EventsController extends AbstractGatherController {
	...
	/**
	 * 
	 * This methods takes the user coordinates and retuns a list of al nearby
	 * events
	 * 
	 * @param request:
	 *            This variable is the http request received from the frontend
	 *            through the rest call to get nearBy events
	 * @param rawData:
	 *            This variable is the data field of the request received from
	 *            the frontend containing user coordinates
	 * @param bindingResult:The
	 *            controller makes this variable available any time an object is
	 *            posted/put from the frontend. It will contain errors if there
	 *            was an error in binding the object. The app continues to use
	 *            its Error interface to report on validation or other errors as
	 *            we continue to process things. Those errors then get reported
	 *            back via the HTTPStatus or Status in our response data.
	 * @return: This method returns a list of nearby events that is obtained
	 *          based on the user coordinates passed into the controller
	 * 
	 */
	...
	/**
	 * 
	 * This method takes info regarding a new event, adds it to the event list,
	 * and returns an update list of events
	 * 
	 * @param request:
	 *            This variable is the request received from the frontend
	 *            through the rest call to add an event
	 * @param rawData:
	 *            This variable is the data field of the request received from
	 *            the frontend containing event info
	 * @param bindingResult:
	 ...
	 *            data.
	 * @return: This method returns a list of updated events which includes the
	 *          newly added event
	 * 
	 */
	...
	/**
	 * 
	 * This method takes updated information about an existing event, updates
	 * the event info, and returns an updated event list.
	 * 
	 * @param request:
	 *            This variable is the request received from the frontend
	 *            through the rest call to update an event
	 * @param rawData:
	 *            This variable is the data field of the request received from
	 *            the frontend containing updated event info
	 * @param bindingResult:
	 *            The controller makes this variable available any time an
	 *            object is posted/put from the frontend. It will contain errors
	 *            if there was an error in binding the object. The app continues
	...
	/**
	 * 
	 * This method, based on the user id, returns a list of event he or she has
	 * joined
	 * 
	 * @param request:
	 *            This variable is the request received from the frontend
	 *            through the rest call to get a list of events joined by the
	 *            user.
	 * 
	 * @return A list of events that the user has joined will be returned back
	 *         to the frontend
	 * 
	 */
	...
	/**
	 * 
	 * This method, based on the user id, returns a list of events her or she
	 * owns
	 * 
	 * @param request:
	 *            This variable is the request received from the frontend
	 *            through the rest call to get a list of events owned by the
	 *            user.
	 * 
	 * @return A list of events that the user has owned will be returned back to
	 *         the frontend
	 * 
	 */
	...
	/**
	 * 
	 * This method, using the event id, will add the user to the list of
	 * participants
	 * 
	 * @param request:
	 *            This variable is the request received from the frontend
	 *            through the rest call to join an event
	 * @param rawData:
	 *            This variable is the data field of the request received from
	 *            the frontend containing event id
	 * @param bindingResult:
	 *            The controller makes this variable available any time an
	 *            object is posted/put from the frontend. It will contain errors
	 *            if there was an error in binding the object. The app continues
	 ...
	 *            reported back via the HTTPStatus or Status in our response
	 *            data.
	 * @return: This method returns the joined event with an updated list of
	 *          participants
	 * 
	 */
	...
	/**
	 * 
	 * This method, using the event id, will remove the user from the list of
	 * participants
	 * 
	 * @param request:
	 *            This variable is the request received from the frontend
	 *            through the rest call to leave an event
	 * @param rawData:
	 *            This variable is the data field of the request received from
	 *            the frontend containing event id
	 * @param bindingResult:
	 ...
	 *            reported back via the HTTPStatus or Status in our response
	 *            data.
	 * @return: This method returns the left event with an updated list of
	 *          participants
	 * 
	 */
	...
	/**
	 * 
	 * This method, using the event id, will remove the event from the event
	 * list
	 * 
	 * @param request:
	 *            This variable is the request received from the frontend
	 *            through the rest call to remove the event
	 * @param rawData:
	 *            This variable is the data field of the request received from
	 *            the frontend containing event id
	 * @param bindingResult:
