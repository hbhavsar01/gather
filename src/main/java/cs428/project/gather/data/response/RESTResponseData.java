...
public class RESTResponseData {
	...
	private static HttpStatus convertErrorCodeToHttpStatus(int errorCode) {
		...
		case -5:
			...
			break;
		case -6:
			// TODO: If we wish to change this back to UNAUTHORIZED, we need to
			// fix SignInControllerTest.testSignInUserWrongPassword()
			// HttpStatus.UNAUTHORIZED causes test to fail since it seems the
			// RestTemplate automatically attempts to retry when this status
