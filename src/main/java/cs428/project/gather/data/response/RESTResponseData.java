...
/**
 * 
 * @author Team Gather Basic REST interface response data contains the return
 *         status, a message, and a timestamp. Based on the validator check,
 *         this class will provide the proper return status.
 * 
 */
public class RESTResponseData {
	...
	/**
	 * Constructor. Create an empty response data.
	 * 
	 */
	...
	/**
	 * Constructor. Create a response data based on return status and message.
	 * 
	 * @param status:
	 *            The return status
	 * @param message:
	...
	/**
	 * Create a basic response data with return status, a message, and HTTP
	 * Status.
	 * 
	 * @param status:
	 *            The return status
	...
	/**
	 * Create a bad request with a proper return status, based on the binding
	 * result.
	 * 
	 * @param bindingResult:
	 *            The binding result that contains the error information form
	 *            the validator
	 * @return: A bad request response with a proper return status, based on the
	 *          binding result.
	 * 
	 */
