 ...
 *         response with the single result with data type, "T"
 * 
 */
public class RESTResourceResponseData<T> extends RESTResponseData {
	...
	public static <T> ResponseEntity<RESTResourceResponseData<T>> badResponse(BindingResult bindingResult) {
		/*
		 * Given that Bar<T> is a subclass of Foo, Java is unable to convert
		 * from Foo to Bar<T> (which makes no sense.) This hack works around
		 * that problem without introducing code duplication
		 */
		...
		return new ResponseEntity<RESTResourceResponseData<T>>(new RESTResourceResponseData<T>(errorResponse.getBody()),
	...
	/**
	 * Constructor. Create a response data based on a regular response data.
	 * 
	 * @param data:
	...
	/**
	 * Constructor. Create a response data based on return status and actual
	 * result.
	 * 
	 * @param status:
	 *            The return status
	...
	/**
	 * Constructor. Create a response data based on return status, return
	 * message and actual result.
	 * 
	 * @param status:
	 *            The return status
	 * @param message:
