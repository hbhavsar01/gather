 ...
 * @author Team Gather
 *
 *         It provides three different user types to the app which are
 *         anonymousUser, registerUser, and admin
 *
 */
...
public enum ActorType {
	...
	/**
	 * This method compares the input and if it is equal to one of the actor
	 * types it sets the SelectedActorType to the that actor type
	 * 
	 * @param value
	 *            passed in from the calling object
	 * @return returns the ActorType selectedActorType which is set in the for
	 *         loop
	 * 
	 */
